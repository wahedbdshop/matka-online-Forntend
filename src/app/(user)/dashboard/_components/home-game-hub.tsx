    ...
    <div className="group relative overflow-hidden rounded-[18px] border border-slate-700 bg-[#222a4a] p-2 transition-all hover:-translate-y-0.5 hover:border-[#f0bf38]/40 hover:bg-[#2a3358]">
      ...
      <div className="relative flex flex-col gap-2">
        <div className="flex items-start justify-between gap-1.5">
          <div className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-[12px] border border-slate-600 bg-slate-900/70">
            {game.logoSrc ? (
              <Image
                src={game.logoSrc}
                alt={game.name}
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex min-w-[76px] shrink-0 flex-col items-center rounded-2xl border px-3 py-3 text-center transition-all duration-200",
                    isActive
