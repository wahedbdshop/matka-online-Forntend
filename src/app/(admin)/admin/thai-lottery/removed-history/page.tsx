...
export default function ThaiRemovedHistoryPage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      AdminService.getRemovedThaiBets({
        page,
        limit: LIMIT,
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Removed Bet History</h1>
            <p className="text-xs text-slate-400">
              Removed bets remain visible only to admin
            </p>
          </div>
        </div>
