            ...
            {isLoading ? (
              ...
              rows.map((row: any, idx: number) => (
                ...
                >
                  ...
                  <td className="border-r border-slate-700/40 px-4 py-3 text-center font-mono text-xs text-cyan-300 last:border-r-0">
                    {getHistoryValue(row.oldValue, ["selectedNumber", "betNumber", "number"])}
                  </td>
                  <td className="border-r border-slate-700/40 px-4 py-3 text-center font-mono text-xs text-emerald-300 last:border-r-0">
