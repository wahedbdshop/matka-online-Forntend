...
function AdminProfileMenu() {
  ...
  return (
    ...
    >
      <span className="sr-only">Open admin profile</span>
...
function AdminSessionGuard() {
  ...
  const { data: sessionsData } = useQuery({
    ...
    enabled: Boolean(user && isAuthenticated && !forceLogoutMutation.isPending),
  ...
  }, [forceLogoutMutation, shouldForceLogout]);
...
export default function AdminLayout({
  ...
  const currentLabel = (() => {
    ...
    if (pathname.startsWith("/admin/profile/sessions/")) {
      return "Profile — Session Details";
    }
