...
export default function SupportAgentProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="rounded-3xl border border-slate-700/50 bg-slate-800/35 p-6">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-500/10 text-cyan-400">
            <User className="h-6 w-6" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-white">Support Agent Profile</h2>
            <p className="text-sm text-slate-400">Manage your profile and password.</p>
          </div>
        </div>
      </div>

      <div className="rounded-2xl border border-slate-700/50 bg-slate-800/35 p-5 space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-yellow-500/30 bg-yellow-500/10 px-4 py-2 text-sm font-medium text-yellow-300"
          >
