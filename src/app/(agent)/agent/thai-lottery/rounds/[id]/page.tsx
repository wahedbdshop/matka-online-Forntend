...
export default function AgentThaiRoundOverviewPage() {
  ...
  const navCards = [
    {
      href: `/agent/thai-lottery/rounds/${id}/close`,
      icon: Clock,
      label: "Close Time",
    ...
    {
      href: `/agent/thai-lottery/rounds/${id}/control`,
      icon: Lock,
      label: "Round Control",
    ...
    {
      href: `/agent/thai-lottery/rounds/${id}/result`,
    ...
    {
      href: `/agent/thai-lottery/rounds/${id}/bets`,
      icon: Gamepad2,
      label: "View Bets",
  ...
  return (
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-3">
        <button
          onClick={() => router.push("/agent/thai-lottery")}
        ...
        <div>
          <h1 className="text-xl font-bold text-white">Round #{round.issueNumber}</h1>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            >
              ...
              <p className={cn("mt-1 text-2xl font-bold tracking-widest", r.color)}>
                {r.value ?? "-"}
              </p>
            </div>
          ))}
      ...
      <div className="space-y-2">
        ...
        {navCards.map((card) => (
          ...
          >
            <div
              className={cn(
                "flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-slate-900/60",
                card.iconColor,
              )}
            >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 truncate text-[11px] text-slate-400">{card.desc}</p>
            </div>
