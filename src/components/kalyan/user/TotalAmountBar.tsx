...
export function TotalAmountBar({
  ...
  return (
    <div className="sticky bottom-0 z-10 mt-2 rounded-xl border border-slate-700/60 bg-slate-900/95 p-2.5 backdrop-blur-sm">
      <div className="grid grid-cols-3 gap-1.5 text-[10px]">
        <div className="rounded-lg border border-slate-700/60 bg-slate-800/70 px-2 py-1.5">
        ...
        <div className="rounded-lg border border-slate-700/60 bg-slate-800/70 px-2 py-1.5">
          ...
          <p className="mt-0.5 font-semibold text-green-300">
